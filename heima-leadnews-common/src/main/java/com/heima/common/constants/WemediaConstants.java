...
public class WemediaConstants {
    ...
    /**
     * 暂时不可用 0 永久不可用 1 正常可用 9
     */
    public static final Integer TEMPORARILY_UNAVAILABLE_USER =0;
    public static final Integer PERMANENTLY_UNAVAILABLE_USER =1;

    public static final Integer NORMALLY_AVAILABLE_USER =9;
